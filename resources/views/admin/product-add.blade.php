        ...
        <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="{{route('admin.product.store')}}">
            ...
            <div class="wg-box">
                ...
                <fieldset class="name">
                    ...
                    <input class="mb-10" type="text" placeholder="e.g. Red, Blue, Gold, Pearl White" name="colors" tabindex="0" value="">
                </fieldset>
                ...
                <fieldset class="name">
                    ...
                    <input class="mb-10" type="text" placeholder="e.g. 6in, 7in, 8in, 9in" name="sizes" tabindex="0" value="">
                </fieldset>
